...
public class GamePerk extends Product{
    ...
    public GamePerk(String productId, String productName, int quantity, BigDecimal price, String perkName, LocalDate expirationDate, boolean isTradeable, String perkDownloadCode) {
